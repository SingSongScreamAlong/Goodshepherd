...
Revision ID: fe126f6b3b53
Revises: 
Create Date: 2025-11-27 07:23:02.263406
...
def upgrade() -> None:
    ...
    sa.Column('minimum_threat', sa.String(length=16), nullable=False),
    sa.Column('minimum_credibility', sa.Float(), nullable=False),
    sa.Column('lookback_minutes', sa.Integer(), nullable=False),
    sa.Column('priority', sa.String(length=16), nullable=False),
    sa.Column('auto_ack', sa.Boolean(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    comment='Normalized open-source intelligence events'
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    comment='Synthesized situational reports and briefs'
    )
